...
const {
  getArticlesByComment,
} = require("./controllers/articles_comment_controller.js");
const { postComment } = require("./controllers/comment_post_controller.js");
const {
  getUpdatedArticle,
} = require("./controllers/patch-article-controller.js");
const {
  deleteComments,
} = require("./controllers/delete-comment-controller.js");
